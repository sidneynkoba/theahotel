...
import { ThaiWedingsComponent } from './weddings/thai-wedings/thai-wedings.component';
import { WesternsWedingsComponent } from './weddings/westerns-wedings/westerns-wedings.component';
...
@NgModule({
  declarations: [
    ...
    ExcursionsComponent,
    WeddingsComponent,
    ThaiWedingsComponent,
    WesternsWedingsComponent,
